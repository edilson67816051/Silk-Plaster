    ...
    <header class="hero">
        ...
        <section class="hero__container container">
            <h4 class="hero__title">BIENVENIDO/A A
                SILK PLASTER</h4>
            <p class="hero__paragraph">¡Bienvenido a nuestro servicio de revestimiento ecológico para paredes! Estamos encantados de tenerte aquí y ayudarte con tus necesidades de diseño de interiores y exteriores. Nuestra empresa se dedica a ofrecer soluciones sostenibles y estéticas para embellecer tus espacios, al tiempo que cuidamos el medio ambiente.</p>
        ...
        <section class="knowledge">
            <div class="knowledge__container container">
                <div class="knowledege__texts">
                    ...
                    <p class="knowledge__paragraph">Nuestra visión es transformar tus espacios, tanto interiores como exteriores, mediante el uso de nuestro revestimiento ecológico para paredes. Queremos combinar diseño y sostenibilidad para crear entornos estéticamente atractivos mientras cuidamos del medio ambiente. En resumen, buscamos embellecer tu vida y el planeta al mismo tiempo.</p>
                    <a href="#" class="cta">Mas informacion</a>
                </div>

                <figure class="knowledge__picture">
                    <img src="https://media.istockphoto.com/id/825382302/es/foto/cat%C3%B3lica-arquidi%C3%B3cesis-de-santa-cruz-de-la-sierra-en-bolivia.jpg?s=1024x1024&w=is&k=20&c=Dgy0wvBEqVQtJ1-N1r26HIL7ZNMSmYSeoEAp4IwYVBI=" class="knowledge__img">
                </figure>
            </div>
        </section>
            ...
            <div class="testimony__container container">
                ...
                <section class="testimony__body testimony__body--show" data-id="1">
                    ...
                    <div class="testimony__texts">
                        <h2 class="subtitle">Mi nombre es Jordan Alexander, <span class="testimony__course">Equipo Silk Plaster .</span></h2>
                ...
                <section class="testimony__body" data-id="2">
                    <div class="testimony__texts">
                        <h2 class="subtitle">Mi nombre es Alejandra Perez, <span class="testimony__course">Equipo Silk Plaster .</span></h2>
                        <p class="testimony__review">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ut est
                ...
                <section class="testimony__body" data-id="3">
                    <div class="testimony__texts">
                        <h2 class="subtitle">Mi nombre es Karen Arteaga, <span class="testimony__course">Equipo Silk Plaster .</span></h2>
                        <p class="testimony__review">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ut est
                ...
                <section class="testimony__body" data-id="4">
                    <div class="testimony__texts">
                        <h2 class="subtitle">Mi nombre es Kevin Ramirez, <span class="testimony__course">Equipo Silk Plaster ..</span></h2>
                        <p class="testimony__review">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ut est
                            esse, niam laboriosam saepe reiciendis dolorem. Cum, ratione voluptatum!</p>
                    </div>
